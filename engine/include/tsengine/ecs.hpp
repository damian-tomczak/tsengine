...
public:
    explicit Pool(uint32_t capacity = 100) : data(capacity, {}) {}
...
inline Entity Registry::createEntity()
{
    ...
    //if (!isQueued)
    //{
    //    throw std::runtime_error{"Entity couldn't be added to the queue of entities to be added."};
    //}

    Entity entity{entityId, nullptr};
    return entity;
}
