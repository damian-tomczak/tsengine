...
DEBUG_LEVEL_VULKAN_FUNCTION(vkCreateDebugUtilsMessengerEXT)
DEBUG_LEVEL_VULKAN_FUNCTION(vkDestroyDebugUtilsMessengerEXT)

#undef DEBUG_LEVEL_VULKAN_FUNCTION
#endif  // DEBUG
